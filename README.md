...
GeoCubes Finland has been created under the [oGIIR project](http://www.geoportti.fi/about/) and as such, is aimed to support the needs of Finnish research community. However, the service and its data is freely usable by anyone interested.
...
GeoCubes Finland on kehitetty osana [oGIIR-hanketta](http://www.geoportti.fi/about/) ja siten suunnattu suomalaisen tutkijayhteisön tarpeisiin. Palvelu ja sen data ovat kuitenkin avoimesti käytettävissä.
